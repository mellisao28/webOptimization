...
Built into the code, there a few instances of the User Timing API
...
var pizzasDiv = document.getElementById("randomPizzas"); //get the first 2 pizzas
for (var i = 2; i < 100; i++) {
    pizzasDiv.appendChild(pizzaElementGenerator(i)); // generate another 98 pizzas
}
